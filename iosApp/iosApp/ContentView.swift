...
struct ContentView: View {
    ...
    let sections = ["home", "technology", "world", "business", "science", "arts", "politics", "sports"]
            ...
            if let article = selectedArticle {
                ...
                VStack(spacing: 0) {
                            ...
                            ForEach(sections, id: \.self) { section in
                                Button(action: {
                                    ...
                                    Text(section.capitalized)
                                        ...
                                        .foregroundColor(selectedSection == section ? Color(UIColor.systemBackground) : Color.primary)
                                        .cornerRadius(16)
                                        .overlay(
                    ...
                    if isLoading {
                        ...
                        List(articles, id: \.uri) { article in
    ...
    func loadNews(section: String) {
        if let cached = cache[section] {
            articles = cached
            return
        }
        ...
        Task {
            do {
                let result = try await repository.getTopStories(section: section)
                articles = result
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Link("Read Full Article on NYT", destination: URL(string: article.url)!)
                        .font(.headline)
                        .frame(maxWidth: .infinity)
                        .padding()
